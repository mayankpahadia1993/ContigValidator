...
if(len(sys.argv)<4):
	...
	print "Example - python align.py referenceGenome.fa outputResults.txt inputFasta.fa"
	exit()
...
for inputFastaFile in inputs:
	...
	with open(inputFastaFile) as f:
		...
		for line in f:
			...
			temp+=line
	inputFasta.append(temp)
	print inputFastaFile,"Input Fasta read"
	...
	print inputFastaFile,"percentage of Alignment - ", percent  
